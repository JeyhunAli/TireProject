...
public class ElementUtil {
    ...
    public void doSendKeysWithFirstClear(By locator, String value) {
	 ...
	 * @return
	 */
	public WebElement doWaitPresenceOfElementLocated(By locator, int timeOut) {
		WebDriverWait wait = new WebDriverWait(driver, timeOut);
	 ...
	 * @return
	 */
	public WebElement doWaitPresenceOfElementLocated(By locator, int timeOut, int intervalTime) {
	...
	/*
	 * wait utility in different format 
	 * for multiple elements 
	 * and for single elements because some of the wait concpets deprecated on selenium4
	 * 
	 */
